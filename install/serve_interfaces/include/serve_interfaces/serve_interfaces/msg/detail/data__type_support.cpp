...
{
  new (message_memory) serve_interfaces::msg::Data(_init);
}

void Data_fini_function(void * message_memory)
{
  auto typed_message = static_cast<serve_interfaces::msg::Data *>(message_memory);
  typed_message->~Data();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Data_message_member_array[1] = {
  {
    ...
    offsetof(serve_interfaces::msg::Data, distance),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Data_message_members = {
  "serve_interfaces::msg",  // message namespace
  "Data",  // message name
  1,  // number of fields
  sizeof(serve_interfaces::msg::Data),
...
{
  return &::serve_interfaces::msg::rosidl_typesupport_introspection_cpp::Data_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, serve_interfaces, msg, Data)() {
  return &::serve_interfaces::msg::rosidl_typesupport_introspection_cpp::Data_message_type_support_handle;
}
