...
static const _Data_type_support_symbol_names_t _Data_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, serve_interfaces, msg, Data)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, serve_interfaces, msg, Data)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, serve_interfaces, msg, Data)() {
  return &::serve_interfaces::msg::rosidl_typesupport_c::Data_message_type_support_handle;
}
